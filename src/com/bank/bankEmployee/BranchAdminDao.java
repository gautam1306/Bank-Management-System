...
public class BranchAdminDao {
	...
	public TreeMap<Integer, LoanType> getLoanTypes() {
		...
		try {
			...
			while (resultSet.next()) {
				loanType.put(resultSet.getInt("loan_type_id"), new LoanType(resultSet.getInt("loan_type_id"),
						resultSet.getFloat("interest_rate"), resultSet.getString("loan_type")));
			}
	...
	protected void addEmployee(String name, String password, String ifsc, String date_of_birth, String aadhaar_number,
			String pan_card, int gender, String mobile_number, String address_house, String address_street,
			String address_district, String address_state, int address_pin_code) {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		try {
	...
	public ArrayList<String> getEmployee(int employeeID) {
		try (Connection connection = Database.getConnection()) {
			try (PreparedStatement preparedStatement = connection
					.prepareStatement(resourceBundle.getString("db.getEmployeeDetails"))) {
